 ...
 */
package de.hybris.beerstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BeerstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BeerstoreFulfilmentProcessConstants.PARENT_PROCESS);
