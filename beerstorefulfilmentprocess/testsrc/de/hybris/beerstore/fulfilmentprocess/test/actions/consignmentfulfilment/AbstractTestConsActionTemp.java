 ...
 */
package de.hybris.beerstore.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, BeerstoreFulfilmentProcessConstants.PARENT_PROCESS);
