 ...
 */
package de.hybris.beerstore.fulfilmentprocess.test.jobs;
...
import de.hybris.beerstore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = BeerstoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
