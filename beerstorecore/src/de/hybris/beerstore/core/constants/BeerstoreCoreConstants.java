 ...
 */
package de.hybris.beerstore.core.constants;

/**
 * Global class for all BeerstoreCore constants. You can add global constants for your extension into this class.
 */
public final class BeerstoreCoreConstants extends GeneratedBeerstoreCoreConstants
{
	public static final String EXTENSIONNAME = "beerstorecore";


	private BeerstoreCoreConstants()
	{
		//empty
	}
