 ...
 */
package de.hybris.beerstore.core.suggestion;
...
import de.hybris.beerstore.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/beerstorecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
