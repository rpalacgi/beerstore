...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/beerstorestorefront/electronics/en",
						"https://electronics.local:9002/beerstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/beerstorestorefront/electronics/en",
						"https://electronics.local:9002/beerstorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/beerstorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/beerstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/beerstorestorefront/electronics/en",
						"https://electronics.local:9002/beerstorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/beerstorestorefront",
						"https://electronics.local:9002/beerstorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/beerstorestorefront",
						"https://electronics.local:9002/beerstorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/beerstorestorefront/electronics/en",
						"https://electronics.local:9002/beerstorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
