 ...
 */
package de.hybris.beerstore.test.setup;
...
import de.hybris.beerstore.test.constants.BeerstoreTestConstants;
import de.hybris.beerstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BeerstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/beerstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/beerstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/beerstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/beerstoretest/import/csquotes.impex");
		}
	}
}
